...
class MarkovGeneratorWord {
    /**
     * 
     * @param {number} n - Order (or length) of each ngram
     * @param {number} max - What is the maximum amount we will generate?
     */
    constructor(n, max) {
        this.n = n;
        this.max = max;
        ...
        /**@type {string[]} A separate array of possible beginnings to generated text*/
        this.beginnings = [];
    }
